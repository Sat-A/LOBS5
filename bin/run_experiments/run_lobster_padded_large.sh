...
python -u -B run_train.py \
        ...
        --blocks=64 --per_gpu_bsz=1 --d_model=4096 --dataset=lobster-prediction --merging=padded \
        ...
        --dt_global=False --epochs=5 --jax_seed=42 --lr_factor=1 --n_layers=48 \
        --opt_config=standard --p_dropout=0.0 --ssm_lr_base=0.00004 --ssm_size_base=4096 \
        ...
        --lr_patience=5 \
        --USE_WANDB=True \
        --wandb_project=lobs5-4096x64-tok24 \
